...
input_file = '/home/chipmunk-151/Robot5A-TB/src/chariot_control/logs/aruco_log.csv'  # Replace with your input file name
...
average_positions = filtered_data.groupby('ArUco ID').agg({
    'Translation X (m)': 'mean',
    'Translation Y (m)': 'mean',
    'Translation Z (m)': 'mean'
}).reset_index()

# Step 4: Save the average positions to a new CSV file
output_file = '/home/chipmunk-151/Robot5A-TB/src/chariot_control/logs_processed/aruco_log_average.csv'  # Replace with your desired output file name
